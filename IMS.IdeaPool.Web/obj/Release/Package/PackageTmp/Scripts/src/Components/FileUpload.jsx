        ...
        return (
            <div ref={el => this.el = el}>
                <div className='form-group'>
                    ...
                    <button type="button" className="btn btn-primary btn-hynds" onClick={this.onBrowseClick.bind(this)} data-toggle="tooltip" title="Attach files.">
                                        ...
                                        <div className="caption">
                                            ...
                                            <p>Size: {file.size}</p>
                                            {
                                                !file.isuploadedviadiscussions ?
                                                    <button type="button" className="btn btn-primary btn-sm btn-hynds" onClick={this.onFileDelete.bind(this, file.name)}>
