                ...
                <div className="col-lg-10 border page-background">
                    ...
                    <div className="form-group">
                        <div className="row">
                            ...
                            <button className="btn btn-primary btn-IMS right" style={{ marginLeft: 1 + '%' }} onClick={this.validate.bind(this, this.saveIdea.bind(this))}>Submit</button>&nbsp;&nbsp;&nbsp;
                            <button className="btn btn-primary btn-IMS right" onClick={this.validate.bind(this, this.saveAsDraft.bind(this))}>Save as Draft</button>
                        </div>
                    </div>
                </div>
                <div className="col-lg-1"></div>
