                ...
                <div className="col-lg-10 border page-background">
                    ...
                    <div className="form-group">
                        <div className="row">
                            ...
                            <button className="btn btn-primary btn-IMS right" style={{ marginLeft: 1 + '%' }} onClick={this.validateAndUpdate.bind(this)}>Submit</button>
                            {
                                this.state.isdraft ?
                                    <button className="btn btn-primary btn-IMS right" onClick={this.validateAndSaveAsDraft.bind(this)}>Save as Draft</button>
                                    : null
                            }
                        </div>
                    </div>
