                                            ...
                                            message.isfile ?
                                                <div>
                                                    ...
                                                    <div className="caption">
                                                        ...
                                                        <a data-toggle="tooltip" title="Download this file." className="btn btn-info btn-circle btn-IMS" href={`/Idea/Download?ideaId=${this.props.channelid}&fileId=${message.fileid}`}>
